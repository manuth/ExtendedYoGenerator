...
[Show differences](https://github.com/manuth/ExtendedYoGenerator/compare/v9.0.4...dev)

## ExtendedYoGenerator v9.0.4
### Fixed
  - Broken code in the `PropertyResolver`-class

[Show differences](https://github.com/manuth/ExtendedYoGenerator/compare/v9.0.3...v9.0.4)
